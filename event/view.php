                              ...
                              <div class="col-md-8">
                                  <div class="blog-item">
                                   <a href="" data-target="#studentmodal" data-toggle="modal" >
                                    <img title="" class="img-hover img-responsive img-blog" style="width:800px;height:230px;"    src="<?php echo web_root. 'event/'.  $res->EventPhoto; ?>">
                                    </a>
                                          ...
                                          <div class="row">  
                                              ...
                                              <div class="col-xs-12 col-sm-10 blog-content">
                                                  ...
                                                  <div class="post-tags">
                                                      ...
                                                      <!-- <a href="../department/index.php?view=edit&id=<?php echo $res->Incharge; ?>"> -->
                                                         <?php 

                                                          $mydb->setQuery("SELECT * FROM `tbldepartment` WHERE DepartmentID=". $res->Incharge);
                                                          $cur = $mydb->loadResultList();

                                                          foreach ($cur as $result) {
                                                            echo   $result->Department.' [ '.$result->Description .' ]';
