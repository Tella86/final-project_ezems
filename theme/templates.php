        ...
        <nav class="navbar navbar-mod navbar-fixed-top" role="banner" style="">
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" style="background-color:#ff9933" data-toggle="collapse"
    ...
    ?><?php }?>
                        ...
                        <li hover="ff9933"
                            class="<?php echo (currentpage_public() == 'student') ? "active" : false; ?>"> <a
                                href="<?php echo web_root; ?>student/">Registered Voters</a></li>
                        <!-- <li  class="<?php echo (currentpage_public() == 'event') ? "active" : false; ?>"> <a href="<?php echo web_root; ?>event/">Events</a></li> -->
                        <li class="<?php echo (currentpage_public() == 'candidate') ? "active" : false; ?>"> <a
                                href="<?php echo web_root; ?>candidate/index.php">Candidates</a></li>

                        <li class="<?php echo (currentpage_public() == 'attendance') ? "active" : false; ?>"> <a
                                href="<?php echo web_root; ?>attendance/">Attendance</a></li>
                        <!-- <li><a href="portfolio.html">Portfolio</a></li> -->
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Events <i
                                    class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu" style="">
                                <li class="<?php echo (currentpage_public() == 'event') ? "active" : false; ?>"><a
                                        href="<?php echo web_root; ?>event/">List of Events</a></li>
                                <li class="<?php echo (currentpage_public() == 'eventwinner') ? "active" : false; ?>"><a
                                        href="<?php echo web_root; ?>eventwinner/">List of Winners</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Utilities <i
                                    class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu" style="">
                                <?php
if ($_SESSION['ACCOUNT_TYPE'] == 'Administrator') {
    # code...
    ?>
                                <li class="<?php echo (currentpage_public() == 'course') ? "active" : false; ?>"><a
                                        href="<?php echo web_root; ?>course/index.php">Courses</a></li>
                                <li class="<?php echo (currentpage_public() == 'department') ? "active" : false; ?>"><a
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Reports <i
                                    class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu" style="">
                                <li class="<?php echo (currentpage_public() == 'report') ? "active" : false; ?>"><a
                                        href="<?php echo web_root; ?>report/index.php?view=event">Events</a></li>
...
if ($_SESSION['ACCOUNT_TYPE'] == 'Administrator') {
    ...
    ?>
                                <li class="<?php echo (currentpage_public() == 'report') ? "active" : false; ?>"><a
                                        href="<?php echo web_root; ?>report/index.php?view=attendance">Attendance</a>
                                </li>
                                ...
                                <li class="<?php echo ($title == 'Candidate') ? "active" : false; ?>"><a
                                        href="<?php echo web_root; ?>report/index.php?view=candidate">Candidates</a>
                                </li>
    ...
    ?>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="">
                                <li>
                                    <a
                                        href="<?php echo web_root; ?>user/index.php?view=edit&id=<?php echo $_SESSION['ACCOUNT_ID']; ?>">Edit</a>
                                </li>
                                <li>
                                    <a
                                        href="<?php echo web_root; ?>user/index.php?view=view&id=<?php echo $_SESSION['ACCOUNT_ID']; ?>">View</a>
                                </li>
                                <li>
...
if ($title != 'Home') {
    ...
    <script type="text/javascript" language="javascript" src="<?php echo web_root; ?>input-mask/jquery.inputmask.js">
    </script>
    ...
    <script type="text/javascript" language="javascript" src="<?php echo web_root; ?>input-mask/meiomask.min.js">
    </script>
