    ...
    <div class="row">
      ...
      <!-- <div class="col-8"> -->
        <h4 class="page-header ">
          <i class="fa fa"></i>EZEMS Transaction Statement
...
?>
      ...
      <div class="features">
								...
								<table id="dash-table" class="table table-striped table-bordered table-hover " style="font-size:12px" cellspacing="0">
								  ...
								  <thead>
								  	<tr>
								  		<th width="14%"> <!-- <input type="checkbox" name="chkall" id="chkall" onclick="return checkall('selector[]');"> -->ID </th>
								  		<th width="14%"> Amount</th>
                                        <th width="14%"> TransactionID</th>
								  		<th width="14%" >TransactionDate</th>
								  		<th width="14%" >PhoneNumber</th>
                  <!-- <tr><th colspan="2"><h4 align="center">Transactions</h4></th></tr> -->


                   <?php

$mydb->setQuery("SELECT * FROM `transactions`");
...
foreach ($cur as $result) {
    ...
    echo '<td>' . $result->TransactionDate . '</td>';
