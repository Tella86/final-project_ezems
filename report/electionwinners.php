      ...
      <section id="feature" class="transparent-bg">
        <div class="container">
           <div class="center wow fadeInDown">
                 <h2 class="page-header"> Election Winners</h2>
...
$sql = "SELECT * FROM `tblcandidate` c, `tblstudent` s
                          WHERE c.`StudentID`=s.`StudentID`
                          AND  DATE_FORMAT( `RunningDate` , '%Y' )= DATE_FORMAT(NOW() , '%Y' )
                          AND `Position`='College-Babaa' ORDER BY TotalVotes DESC LIMIT 1";
$mydb->setQuery($sql);
$cur = $mydb->loadResultList();
...
$sql = "SELECT * FROM `tblcandidate` c, `tblstudent` s
                          WHERE c.`StudentID`=s.`StudentID`
                          AND  DATE_FORMAT( `RunningDate` , '%Y' )= DATE_FORMAT(NOW() , '%Y' )
                          AND `Position`='College-Mamaa' ORDER BY TotalVotes DESC LIMIT 1";
$mydb->setQuery($sql);
$cur = $mydb->loadResultList();
...
$sql = "SELECT * FROM `tblcandidate` c, `tblstudent` s
                          WHERE c.`StudentID`=s.`StudentID`
                          AND  DATE_FORMAT( `RunningDate` , '%Y' )= DATE_FORMAT(NOW() , '%Y' )
                          AND `Position`='Games-Captain' ORDER BY TotalVotes DESC LIMIT 1";
$mydb->setQuery($sql);
$cur = $mydb->loadResultList();
...
$sql = "SELECT * FROM `tblcandidate` c, `tblstudent` s
                          WHERE c.`StudentID`=s.`StudentID`
                          AND  DATE_FORMAT( `RunningDate` , '%Y' )= DATE_FORMAT(NOW() , '%Y' )
                          AND `Position`='Class-Rep' ORDER BY TotalVotes DESC LIMIT 1";
$mydb->setQuery($sql);
$cur = $mydb->loadResultList();
...
$sql = "SELECT * FROM `tblcandidate` c, `tblstudent` s
                          WHERE c.`StudentID`=s.`StudentID`
                          AND  DATE_FORMAT( `RunningDate` , '%Y' )= DATE_FORMAT(NOW() , '%Y' )
                          AND `Position`='Dorm-Head' ORDER BY TotalVotes DESC LIMIT 8";
$mydb->setQuery($sql);
$cur = $mydb->loadResultList();
